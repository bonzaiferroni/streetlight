...
val LayoutUtilityCss
    get() = listOf(
        ...
        // Align
        JustifyContentEnd, JustifyContentSpaceAround, JustifyContentSpaceBetween,
...
val Margin1 = utilityOf("margin-1", "margin: var(--unit)")
val Margin2 = utilityOf("margin-2", "margin: calc(var(--unit) * 2)")
val MarginTop1 = utilityOf("margin-top-1", "margin-top: var(--unit)")
val MarginTopTiny = utilityOf("margin-top-2px", "margin-top: 2px")
val MarginTop2 = utilityOf("margin-top-2", "margin-top: calc(var(--unit) * 2)")
val MarginTop4 = utilityOf("margin-top-4", "margin-top: calc(var(--unit) * 4)")
val MarginTop8 = utilityOf("margin-top-8", "margin-top: calc(var(--unit) * 8)")
val MarginLeft1 = utilityOf("margin-left-1", "margin-left: var(--unit)")
val MarginLeft2 = utilityOf("margin-left-2", "margin-left: var(--unit-2)")
val MarginLeftAuto = utilityOf("margin-left-auto", "margin-left: auto")
val MarginRight1 = utilityOf("margin-right-1", "margin-right: var(--unit)")
val MarginRight2 = utilityOf("margin-right-2", "margin-right: var(--unit-2)")
val MarginRight4Px = utilityOf("margin-right-4px", "margin-right: 4px")
val MarginBottom1 = utilityOf("margin-bottom-1", "margin-bottom: var(--unit)")
val MarginBottom2 = utilityOf("margin-bottom-2", "margin-bottom: calc(var(--unit) * 2)")
val MarginBottom16 = utilityOf("margin-bottom-16", "margin-bottom: calc(var(--unit) * 16)")
...
val Padding1 = utilityOf("padding-1", "padding: var(--unit)")
val Padding2 = utilityOf("padding-2", "padding: calc(var(--unit) * 2)")
val Padding2Px = utilityOf("padding-2px", "padding: 2px")
val Padding4 = utilityOf("padding-4", "padding: calc(var(--unit) * 4)")
val PaddingTiny = utilityOf("padding-tiny", "padding: 2px")
val PaddingLeft1 = utilityOf("padding-left-1", "padding-left: var(--unit)")
val PaddingLeft2 = utilityOf("padding-left-2", "padding-left: var(--unit-2)")
val PaddingLeft3 = utilityOf("padding-left-3", "padding-left: var(--unit-3)")
val PaddingRight1 = utilityOf("padding-right-1", "padding-right: calc(var(--unit) * 1)")
val PaddingRight3 = utilityOf("padding-right-3", "padding-right: calc(var(--unit) * 3)")
val PaddingTop1 = utilityOf("padding-top-1", "padding-top: var(--unit)")
...
val PaddingBottom1 = utilityOf("padding-bottom-1", "padding-bottom: var(--unit)")
...
val TopSpacing1 = utilityOf("top-spacing-1", "top: var(--unit)")
val TopSpacing8 = utilityOf("top-spacing-8", "top: calc(var(--unit) * 8)")
