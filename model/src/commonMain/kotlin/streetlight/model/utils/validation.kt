...
//
//val Username.validUsernameLength: Boolean
//    get() = string.length in Username.MIN_LENGTH..Username.MAX_LENGTH
//val Username.validUsernameChars: Boolean
//    get() = string.all() { it.isLetterOrDigit() || it == '_' }
//val Username.validUsername: Boolean
