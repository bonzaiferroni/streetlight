...
object Api: ApiNode(ApiNode(null, "api"), "v1") {
    ...
    object Galaxies: ApiNode(this, "galaxy") {
        ...
        object ReadId: GetByIdEndpoint<GalaxyId, Galaxy>(this, "id")
        object PostEvent: PostEndpoint<EventPostEdit, Post>(this, "post-event")
        object PostContent: PostEndpoint<ContentEdit, Post>(this, "post-content")
        object EditContent: PostEndpoint<ContentEdit, Post>(this, "edit-content")
