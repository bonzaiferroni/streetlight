...
class BrowserDocClient(private val client: FetchClient): DocClient {
    override suspend fun readSiteDoc(docId: DocId) = client.getApi(Api.Docs, docId)
    override suspend fun readSiteDocTable() = client.getApi(Api.DocsTable)
}
