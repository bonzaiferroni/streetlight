...
fun ViewContext<LocationFinderProto>.viewLocationFinderProto() {
...
fun ViewContext<LocationFinderProto>.viewLocationFinderPlace() {
    val app = model.app
...
fun ViewContext<LocationFinderProto>.viewLocationFinderEdit() {
    ...
    column {
        ...
        card {
            // viewLocationEditor(edit, model.app, editFlow, false, model::setEdit)
...
fun ViewContext<LocationFinderProto>.viewLocationFinderComplete() {
