...
class TestStatusClient: StatusClient {
    override suspend fun feedSiteStatusFeed(resolution: MetricResolution): Outcome<SiteStatusFeed> = TODO()
    override suspend fun readLastSiteStatus(resolution: MetricResolution): Outcome<SiteStatus> = TODO()
}
