...
class TestTaskClient: TaskClient {
    override suspend fun readUserTasks(): Outcome<List<TaskContent>> = TODO()
    override suspend fun readReview(taskId: TaskId): Outcome<TaskContent> = TODO()
}
