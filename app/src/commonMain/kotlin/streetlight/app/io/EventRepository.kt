...
interface EventRepository {
    ...
    suspend fun createEvent(event: EventUpdate): Event?
...
class EventApiClient(
    ...
    override suspend fun createEvent(event: EventUpdate) = client.request(Api.Events.Create, event)
...
class EventMockClient: EventRepository {
    ...
    override suspend fun createEvent(event: EventUpdate): Event? = TODO("Not yet implemented")
