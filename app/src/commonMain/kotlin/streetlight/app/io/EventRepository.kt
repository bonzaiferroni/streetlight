...
interface EventRepository {
    ...
    suspend fun createEvent(event: EventEdit): Event?
...
class EventApiClient(
    ...
    override suspend fun createEvent(event: EventEdit) = client.request(Api.Events.CreateEvent, event)
...
class EventMockClient: EventRepository {
    ...
    override suspend fun createEvent(event: EventEdit): Event? = TODO("Not yet implemented")
